...
export default function Home() {
  ...
  return (
    <div ref={topRef} className="min-h-screen bg-gray-50 text-gray-900">
      ...
      {/* ── Calculator ── */}
      <section id="calculator" ref={calculatorRef} className="relative py-20 px-4 bg-gray-50 border-t border-gray-200 overflow-hidden min-h-screen">
            ...
            <div className="space-y-6 bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 shadow-sm">
              ...
              <div>
                <input
                  ...
                  // WHY: +$1.50 range covers realistic price spikes without
                  // showing unrealistic prices that would never happen.
                  max={Math.round((localPrice.price + 1.5) * 100)}
                  step={5}
                ...
                <div className="flex justify-between text-xs text-gray-400 mt-1">
                  ...
                  <span>${(localPrice.price + 1.5).toFixed(2)} (wider = lower price)</span>
                </div>
              </div>
